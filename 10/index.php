...
<head>
	<!-- content type tag - for character encoding - must be used for every website -->
	<meta charset="utf-8">

	<!-- this meta will tell mobile phones to not zoom out of the page by starting with the scale of 1 -->
	<meta name="viewport" content="width=device-width, initial-scale=1.0">

	<!-- SEO - this is the description of the website for google -->
	...
	<!-- this is to decrease the favicon - the one that can be seen in the title tab -->
...
<body>
	...
	<section class="section-features js--section-features" id="features">
		...
		<div class="row js--wp-1">
			<div class="col span-1-of-4 box">
				...
				<p>Never cook again! We really mean that. Our subscription plans include up to 365 days/year coverage. You can also
			...
			<div class="col span-1-of-4 box">
				...
				<h3>100% organic</h3>
				<p>All our vegetables are fresh, organic and local. Animals are raised without added hormones or antibiotics. Good
					for your health, the environment, and it also tastes better!</p>
			</div>
			<div class="col span-1-of-4 box">
	...
	<section class="section-cities" id="cities">
		...
		<div class="row js--wp-3">
			<div class="col span-1-of-4 box">
				<img src="resources/img/lisbon-min.jpg" alt="Lisbon">
				<h3>Lisbon</h3>
	...
	<section class="section-testimonials">
		...
		<div class="row">
			...
			<div class="col span-1-of-3">
				<blockquote>
					Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in
			...
			<div class="col span-1-of-3">
				<blockquote>
					I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with
	...
	<script src="http://maps.google.com/maps/api/js"></script> <!-- this is for the map -->
	<script src="resources/js/scripts.js"></script>
	<script src="resources/js/gmaps.js"></script> <!-- this is for the map -->
